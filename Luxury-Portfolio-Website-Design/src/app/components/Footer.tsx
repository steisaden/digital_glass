    ...
    <footer className="relative py-20 px-6 md:px-12 bg-[#0a0a0f] border-t border-white/10">
      <div className="relative max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h3 
              className="text-3xl mb-4 text-amber-500"
              style={{ 
            ...
            <div className="flex gap-4">
              {[Linkedin, Twitter, Github].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-full backdrop-blur-xl bg-white/[0.05] border border-white/10 flex items-center justify-center hover:bg-amber-500 hover:border-amber-500 transition-all duration-500"
                >
          ...
          {/* Services */}
          <div>
            <h4 className="text-white mb-4" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>
              Services
            </h4>
            <ul className="space-y-3">
              {["Headless Commerce", "Geospatial Intelligence", "Immersive 3D", "Digital Strategy", "VR Experiences"].map((item, i) => (
                <li key={i}>
                  <a href="#" className="text-slate-400 hover:text-amber-500 transition-colors duration-300" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}>
                    {item}
                  </a>
                </li>
              ))}
