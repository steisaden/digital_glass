                    ...
                    >
                        <div className="flex-1 overflow-y-auto overscroll-behavior-contain custom-scrollbar">
                            ...
                            <div className="p-8 md:p-12 space-y-12">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        {project.metrics.map((metric) => (
                                            <div key={metric.label} className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 overflow-hidden">
                                                <div className="sm:w-1/3 shrink-0">
                                                    <p className="text-4xl text-white mb-2 truncate" style={{ fontFamily: "var(--font-heading)", fontWeight: 700 }} title={metric.value}>
                                                        {metric.value}
                                                    </p>
                                                    <p className="text-sm uppercase tracking-[0.2em] text-primary break-words" title={metric.label}>{metric.label}</p>
                                                </div>
                                                <div className="sm:w-2/3 border-t sm:border-t-0 sm:border-l border-white/10 pt-4 sm:pt-0 sm:pl-8">
                                                    <p className="text-lg text-slate-300 leading-relaxed break-words">{metric.detail}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div>
                                    <h3 className="text-2xl font-serif mb-6 text-white">Project Impact</h3>
                                    <div className="rounded-2xl border border-dashed border-primary/30 bg-primary/5 p-6">
                                        <p className="text-sm text-slate-400 mb-4">
                                            Measurable outcomes and value generated by this project.
                                        </p>
