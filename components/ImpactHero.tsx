                ...
                >
                    ...
                    <div className="relative backdrop-blur-2xl bg-white/[0.03] border border-white/10 rounded-3xl p-12 md:p-16 shadow-2xl">
                        ...
                        <div className="relative z-10">
                            ...
                            >
                                <p className="text-primary tracking-[0.3em] uppercase text-sm mb-6" style={{ fontFamily: 'var(--font-sans)', fontWeight: 600 }}>
                                    Digital Authority
                                </p>
                            </motion.div>
                            ...
                            <motion.p
                                ...
                                className="text-slate-300 text-xl md:text-2xl mb-12 max-w-2xl leading-relaxed"
